...
public final class ImportUtilities {
    private static final String CACHE_DIRECTORY = "dynapaper";
    ...
    public static boolean addBookCoverToCache(GalleryItem item, Bitmap bitmap) {
        File cacheDirectory;
        try {
        ...
        File coverFile = new File(cacheDirectory, item.getThumbnailFilename());
